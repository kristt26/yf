<?= $this->extend('jemaat/sidi/index') ?>
<?= $this->section('item') ?>
<div class="col-md-12">
    <a href="<?= base_url("layanan_sidi?item=") . $add ?>" class="btn btn-primary btn-sm mb-2" id="myButton"><i class="mdi mdi-plus-circle"></i> Daftarkan</a>
