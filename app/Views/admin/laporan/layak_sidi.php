...
<div class="col-md-12" ng-controller="laporanController">
    <div class="row">
        <div class="col-md-6">
            <a class="btn btn-primary btn-sm mb-2" id="printSidi" target="_blank"><i class="mdi mdi-file-excel-box"></i> Export</a>
            <a class="btn btn-info btn-sm mb-2" id="cetakSidi" target="_blank"><i class="mdi mdi-printer"></i> Cetak</a>
        </div>
                ...
                <div class="col-sm-6">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" onchange="setValue()" name="statusSidi" id="membershipRadios1" value="sudah"> Sudah SIDI </label>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-check">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" onchange="setValue()" name="statusSidi" id="membershipRadios2" value="belum"> Belum SIDI </label>
                    </div>
                </div>
            </div>
        </div>
