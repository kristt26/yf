                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <select name="jenis_identitas" id="jenis_identitas" ui-select2 class="form-control form-control-sm select2" data-placeholder="Jenis Identitas" ng-model="model.jenis_identitas" required>
                                    <!-- <option ng-if="!model.id" value=""></option> -->
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="status_perkawinan" id="status_perkawinan" ui-select2 class="form-control form-control-sm select2" data-placeholder="---Status Perkawinan---" ng-model="model.status_perkawinan" required>
                                    <!-- <option value=""></option> -->
